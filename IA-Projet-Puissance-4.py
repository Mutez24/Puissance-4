...
## Permet de faire la liste de tous les coups possibles selon la 
## grille de jeu passée en parametre
## s est la grille de jeu
## Retourne une liste de liste des actions possibles, où chaque liste de liste est une 
## liste de 2 cases qui stock [abscisse, ordonnée] de chaque coup possible
def Action(s):
    actions=[]
...
## Permet d'appliquer l'action a, au joueur player, sur la grille s
## Retourne la grille nextState où l'action a, a été appliqué sur la grille s
## par le joueur player
...
## Permet de savoir quand le jeu est finis 
## Soit il y a un gagant, soit les 42 pions sont posés
## Pernd en parametre la grille de jeu à évaluer
## Return True si le jeu est finis, false sinon
def TerminalTest(s):
    compteur = 0
    char = 'X'
    charoppose = 'O'
...
## Permet de donner une valeur a la grille state pour le joueur player
## Prend en parametre:
## state : qui est la grille de jeu a évaluer
## player : qui est le joueur a qui on va évaluer la utility
## p3,p32,p4,p3A,p4A sont des parametres de notre utility qui permette 
## d'apporter plus ou moins d'importance aux alignements de 3 et 4 pions par
## l'adversaire et le player
## Return result qui est la valeur de la utility
def Utility(state, player,p3,p32,p4,p3A,p4A): 
    result=0 
    compteur = 0 
    char = player 
...
## State est la grille vide de depart passée en parametre
## Joueur est X ou O
## Return l'action a jouer et le V
def Alpha_Beta(state,joueur,p3,p32,p4,p3A,p4A):
    if(joueur == 'X') : 
        opposant = 'O'
    if(joueur == 'O') : 
        opposant = 'X'
...
if __name__=='__main__' :
    '''------------Permet de tester nos fonctions unitaires-----------------'''
    ##Affiche(grid)
    
    ##print(TerminalTest(grid))
    ...
    ##newgrid = Result(grid, action[5],'X')
    ##Affiche(newgrid)
    '''---------------------------------------------------------------------'''
